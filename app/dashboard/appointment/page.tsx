          ...
          {department && (
            <div className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-6 space-y-4">
              ...
              {loadingDoctors ? (
                ...
                <p className="text-sm text-slate-500 py-4 text-center">No doctors available in this department</p>
              ) : (
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white/[0.05] border border-white/[0.1] rounded-xl px-4 py-2.5 text-sm text-slate-200 focus:outline-none focus:border-sky-500/50 focus:ring-1 focus:ring-sky-500/20 transition-all"
                  />
                </div>
                <div>
                  <label className="text-xs text-slate-500 mb-1.5 block">Time (optional)</label>
                  <input
                    type="time"
                    value={time}
