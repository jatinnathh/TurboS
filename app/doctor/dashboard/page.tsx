              ...
              <>
                ...
                {requests.map((req) => (
                  ...
                  >
                    ...
                    <span className={`inline-flex items-center text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full ${req.doctorId !== doctor.id ? "bg-amber-500/10 text-amber-400 ring-1 ring-amber-500/30" : statusBadge(req.status)}`}>
                      {req.doctorId !== doctor.id ? "REFERRED" : req.status.replace("_", " ")}
                    </span>
